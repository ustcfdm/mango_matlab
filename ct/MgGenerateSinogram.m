...
% N0_bin: photon counts of background/air after binning [1 x 1 x bins]
% N_bin: photon counts of object after binning [rows x cols x bins]
...
N_bin = zeros(rows, cols, binCount);
N0_bin = zeros(1, 1, binCount);
